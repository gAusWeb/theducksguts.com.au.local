...
function pixia_init() 
{
	...
	jQuery('#nav-main ul li a').each(function(index) 
	{
        ...
        function calculate_filters() { 
                ...
                jQuery('#nav-main>div>ul.sf-menu>li>ul.sub-menu>li>a').each(
            function(e) 
                {
                ...
                jQuery('#nav-main>div>ul.sf-menu>li>ul.sub-menu>li>ul.sub-menu>li>a').each(
            function(e) 
                {
            ...
            function(e) 
                ...
                jQuery('.nav-parent>ul.sub-menu>li>a').each(
            function(e) 
                {
