<?php
	...
	function slides_register() 
	{
		...
		$args = array(
			...
			'public' => true,
                        ...
                        'show_ui' => true,
                        'query_var' => true,
                        'menu_icon' => get_template_directory_uri() . '/images/admin/menu.png',
	...
	add_theme_support( 'automatic-feed-links' );
        ...
        {
                if ($variable_val!="courier_new" && $variable_val!="helvetica" && $variable_val!="Arial" && $variable_val!="Signalist")
                {
                        return true;
                }
                else
