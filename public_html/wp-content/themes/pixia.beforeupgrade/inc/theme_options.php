	...
	$select_font_options = array(
		...
		'27' => array(
			...
			'label' => __( 'Vollkorn', 'eboardtheme' )
                ...
                '57' => array(
                        'value' =>      'Signalist',
                        'label' => __( 'Signalist', 'eboardtheme' )
                )
                //58 IS NEXT
        );
                               ...
                               ?>
                                <tr valign="top">
                                    ...
                                    <td>
                                        ...
                                        <input id="pixia_theme_options_logo_w" type="hidden" size="4" type="text" name="pixia_theme_options[logo_w]" value="<?php echo( $options['logo_w'] ); ?>" />
                                        <tr>
                                        <td>
                                ...
                                //ABOVE MENU SIDEBAR
                                ?>
                                <tr valign="top"><th scope="row"><?php _e( 'Display Above Menu Sidebar', 'pixiatheme' ); ?></th>
                                    <td>
                                        <select name="pixia_theme_options[above_sidebar]">
                                            <?php    
                                                foreach ( $yesno_options as $option ) 
                                                {
                                                    $label = $option['label'];
                                                    
                                                    if ( $options['above_sidebar'] == $option['value'] ) // Make default first in list
                                                        echo "\n\t<option style=\"padding-right: 10px;\" selected='selected' value='" . esc_attr( $option['value'] ) . "'>$label</option>";
                                                    else
                                                        echo "\n\t<option style=\"padding-right: 10px;\" value='" . esc_attr( $option['value'] ) . "'>$label</option>";
                                                }
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input id="footer_text" size="30" maxlength="100" type="text" name="pixia_theme_options[footer_text]" value="<?php echo( $options['footer_text'] ); ?>" />
                            ...
                            <table class="form-table">
                               ...
                               <?php
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <textarea id="css_text" class="" rows="" cols="60" name="pixia_theme_options[js_text]" value=""><?php esc_attr_e( $options['js_text'] ); ?></textarea>
